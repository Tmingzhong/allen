...
export async function up({ payload, req }: MigrateUpArgs): Promise<void> {
  await payload.db.drizzle.execute(sql`
   CREATE TYPE "public"."enum_pages_type" AS ENUM('ywgl', 'jqzx', 'jqhd', 'jqgg', 'swhz');
  CREATE TYPE "public"."enum_pages_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__pages_v_version_type" AS ENUM('ywgl', 'jqzx', 'jqhd', 'jqgg', 'swhz');
  ...
  DO $$ BEGIN
   ALTER TABLE "header_images" ADD CONSTRAINT "header_images_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "header_images" ADD CONSTRAINT "header_images_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."header"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "header_images_order_idx" ON "header_images" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "header_images_parent_id_idx" ON "header_images" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "header_images_image_idx" ON "header_images" USING btree ("image_id");`)
}
